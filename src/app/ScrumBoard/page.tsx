    ...
    return (
        <div>
            ...
            <li>
              ...
              >
                <h3 className="w-10 h-10 text-gray-500">+</h3>
        ...
        {boardData[0].items.length+  boardData[1].items.length + boardData[2].items.length +boardData[3].items.length + +boardData[4].items.length == 0  ?(
