...
const Timesheet = React.memo(() => {
    ...
    const [config, setConfig] = useState({
        ...
        onBeforeEventRender: (args: any) => {
            ...
            const project =
                name.find((p) => p.id === args.data.project) ||
                name.find((p) => p.id === args.data.text.project) ||
                name.find((p) => p.id === args.project);
        ...
        onTimeRangeSelected: async (args: any) => {
            ...
            const form = [
                ...
                { name: "Start", id: "start", type: "datetime" },
                {
                    ...
                    onValidate: (args) => {
                        if (
                            args.values.end.getTime() <
                            args.values.start.getTime()
                        ) {
                            args.valid = false;
    ...
    return (
        <div className="flex flex-col justify-center center-items">
            <div className="my-4 flex text-5xl font-extrabold justify-center items-center">
